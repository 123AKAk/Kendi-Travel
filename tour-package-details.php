            ...
            <div class="row gy-5 justify-content-center">
                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show active" id="v-pills-information" role="tabpanel" aria-labelledby="v-pills-information-tab">
                            <div class="tour-information">
                                <div class="tour-price"><h3>$175 /</h3><span>per person</span></div>
                                ...
                                <div class="row details-img-group justify-content-center g-4">
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-6">
                                        <img src="assets/images/blog/blog-details-img2.png" class="img-fluid" alt="image">
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-6">
                                        <img src="assets/images/blog/blog-details-img3.png" class="img-fluid" alt="image">
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-6">
                                        <img src="assets/images/blog/blog-details-img4.png" class="img-fluid" alt="image">
                                    </div>
                                </div>
                                <div class="faq-area">
                                    <h3 class="tour-details-subtitle">Frequently Asked Questions</h3>
                        ...
                        <div class="tab-pane fade" id="v-pills-gallery" role="tabpanel" aria-labelledby="v-pills-gallery-tab">
                            <div class="tour-gallery-wrap">
                                <h3 class="tour-details-subtitle">Kendi Travel Travel Gallery</h3>
                                    ...
                                    <div class="col-xxl-4 col-xl-4 col-lg-4 col-sm-4 col-6">
                                        <div class="tour-gallery">
                                            <a href="assets/images/gallery/tour-gallery1.png" class="image-open">
                                                <img src="assets/images/gallery/tour-gallery1.png" class="img-fluid" alt="image">
                                            </a>
                                        </div>
                                        <div class="tour-gallery">
                                            <a href="assets/images/gallery/tour-gallery2.png" class="image-open">
                                                <img src="assets/images/gallery/tour-gallery2.png" class="img-fluid" alt="image">
                                            </a>
                                        </div>
                                        <div class="tour-gallery">
                                            <a href="assets/images/gallery/tour-gallery3.png" class="image-open">
                                                <img src="assets/images/gallery/tour-gallery3.png" class="img-fluid" alt="image">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-xxl-4 col-xl-4 col-lg-4 col-sm-4 col-6">
                                        <div class="tour-gallery">
                                            <a href="assets/images/gallery/tour-gallery4.png" class="image-open">
                                                <img src="assets/images/gallery/tour-gallery4.png" class="img-fluid" alt="image">
                                            </a>
                                        </div>
                                        <div class="tour-gallery">
                                            <a href="assets/images/gallery/tour-gallery5.png" class="image-open">
                                                <img src="assets/images/gallery/tour-gallery5.png" class="img-fluid" alt="image">
                                            </a>
                                        </div>
                                        <div class="tour-gallery">
                                            <a href="assets/images/gallery/tour-gallery6.png" class="image-open">
                                                <img src="assets/images/gallery/tour-gallery6.png" class="img-fluid" alt="image">
                                            </a>
                                        </div>
                                        <div class="tour-gallery">
                                            <a href="assets/images/gallery/tour-gallery7.png" class="image-open">
                                                <img src="assets/images/gallery/tour-gallery7.png" class="img-fluid" alt="image">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-xxl-4 col-xl-4 col-lg-4 col-sm-4 col-6">
                                        <div class="tour-gallery">
                                            <a href="assets/images/gallery/tour-gallery8.png" class="image-open">
                                                <img src="assets/images/gallery/tour-gallery8.png" class="img-fluid" alt="image">
                                            </a>
                                        </div>
                                        <div class="tour-gallery">
                                            <a href="assets/images/gallery/tour-gallery9.png" class="image-open">
                                                <img src="assets/images/gallery/tour-gallery9.png" class="img-fluid" alt="image">
                                            </a>
                                        </div>
                                        <div class="tour-gallery">
                                            <a href="assets/images/gallery/tour-gallery10.png" class="image-open">
                                                <img src="assets/images/gallery/tour-gallery10.png" class="img-fluid" alt="image">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane fade" id="v-pills-review" role="tabpanel" aria-labelledby="v-pills-review-tab">
                            <div class="tour-review-area">
                                <h3 class="tour-details-subtitle">Kendi Travel Client Review</h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="sidebar-offer">
                        ...
                        <img src="assets/images/bg/sidebar-offer.png" class="img-fluid" alt="image">
                    </div>
                </div>
            </div>
        </div>
