...
?>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-8 col-md-10 col-sm-12">
                    <div class="breadcrumb-area">
                        <span>Welcome to Kendi Travel</span>
    ...
    <div class="feature-section2 pt-120">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6 ps-lg-5">
                    ...
                    <a href="tour-package.php" class="eg-btn btn--primary-outline sibling-2 btn--lg">Find tours</a>
                </div>
                <div class="col-lg-6">
    ...
    <div class="guide-section pt-120 pb-120">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xxl-6 col-xl-8 col-md-10 col-sm-12 text-center">
            ...
            <div class="row g-xl-5 g-4 justify-content-center">
                ...
                <!-- display best tour guides with highest book count -->

                <div class="col-lg-4 col-lg-4 col-md-6 col-sm-10">
                    <div class="tour-guide-single sibling-2">
                ...
                <div class="row g-4 d-flex justify-content-center">
                        ...
                        <div class="counter-single text-center d-flex flex-column hover-border1">
                            ...
                            <div class="coundown d-flex flex-column">
                                <div class="d-flex flex-row justify-content-center align-items-center gap-2">
                                    <h3 class="odometer" data-odometer-final="<?= $tourcount ?>">01</h3><i class="bi bi-plus-lg"></i>
                                </div>
                                <p>Awesome Tour</p>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-10">
                      <div class="counter-single text-center d-flex flex-column hover-border1">
                        <div class="counter-icon">
                          ...
                          <div class="coundown d-flex flex-column">
                            <div class="d-flex flex-row justify-content-center align-items-center gap-2">
                                <h3 class="odometer" data-odometer-final="<?= $stunningplaces ?>">01</h3><i class="bi bi-plus-lg"></i>
                            </div>
                              <p>Stunning Places</p>
                          </div>    
                      </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-10">
                      <div class="counter-single text-center d-flex flex-column hover-border1">
                        <div class="counter-icon">
                          ...
                          <div class="coundown d-flex flex-column">
                            <div class="d-flex flex-row justify-content-center align-items-center gap-2">
                                <h3 class="odometer" data-odometer-final="<?= $satisfiedcustomers ?>">01</h3><i class="bi bi-plus-lg"></i>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-10">
                        <div class="counter-single text-center d-flex flex-column hover-border1">
                          ...
                          <div class="coundown d-flex flex-column">
                            <div class="d-flex flex-row justify-content-center align-items-center gap-2">
                                <h3 class="odometer" data-odometer-final="<?= $travelguides ?>">01</h3><i class="bi bi-plus-lg"></i>
                            </div>
                              <p>Travel Guides</p>
                          </div>
                      </div>
        ...
        <div class="container-fluid px-0">
            <div class="testimonial-wrapper">
                <div class="testimonial-area">
                    ...
                    <div class="testimonial-wrap fadeInLeft">
    ...
    <!-- =============== facilitise-section start  =============== -->

   <div class="facilities-section2 pt-120 pb-120">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xxl-6 col-xl-8 col-md-10 col-sm-12 text-center">
                <div class="section-title1">
