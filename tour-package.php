            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="best-plan-single1">
                        <div class="image">
                            <img src="assets/images/bg/best-plan21.png" class="img-fluid" alt="image">
                        </div>
                        <div class="content">
                            <p>From $200</p>
                            <h4><a href="tour-package-details.php">Bangkok & Krabi</a></h4>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="best-plan-single1">
                        <div class="image">
                            <img src="assets/images/bg/best-plan22.png" class="img-fluid" alt="image">
                        </div>
                        <div class="content">
                            <p>From $200</p>
                            <h4><a href="tour-package-details.php">Caribbean Cooking</a></h4>
                            <div class="best-plan-meta">
                                <span class="duration"><i class="bi bi-clock"></i>2 days 3 night</span>
                                <span class="rating"><i class="bi bi-star-fill"></i>4.8 (150)</span>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="best-plan-single1">
                        <div class="image">
                            <img src="assets/images/bg/best-plan23.png" class="img-fluid" alt="image">
                        </div>
                        <div class="content">
                            <p>From $200</p>
                            <h4><a href="tour-package-details.php">Amazing Bangkok</a></h4>
                            <div class="best-plan-meta">
                                <span class="duration"><i class="bi bi-clock"></i>2 days 3 night</span>
                                <span class="rating"><i class="bi bi-star-fill"></i>4.8 (150)</span>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="best-plan-single1">
                        <div class="image">
                            <img src="assets/images/bg/best-plan24.png" class="img-fluid" alt="image">
                        </div>
                        <div class="content">
                            <p>From $200</p>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="best-plan-single1">
                        <div class="image">
                            <img src="assets/images/bg/best-plan25.png" class="img-fluid" alt="image">
                        </div>
                        <div class="content">
                            <p>From $200</p>
                            <h4><a href="tour-package-details.php">Pyramids, Egypt</a></h4>
                            <div class="best-plan-meta">
                                <span class="duration"><i class="bi bi-clock"></i>2 days 3 night</span>
                                <span class="rating"><i class="bi bi-star-fill"></i>4.8 (150)</span>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="best-plan-single1">
                        <div class="image">
                            <img src="assets/images/bg/best-plan26.png" class="img-fluid" alt="image">
                        </div>
                        <div class="content">
                            <p>From $200</p>
