...
?>
    ...
    <div class="banner-section2"> 
        <div class="swiper banner2-slider">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img src="assets/images/slider/home02/image01.png" class="banner-bg11" alt="image">
                    <div class="container">
                        <div class="row justify-content-lg-start justify-content-center align-items-center g-4">
                            <div class="col-xl-6 col-lg-7 col-md-12 text-lg-start text-center">
                                <div class="banner2-content">
                                    ...
                                    <a href="destination.php" class="eg-btn btn-primary2-outline btn--lg">Discover More</a>
                                </div> 
                            </div>
                        </div>
                    </div>  
                ...
                <div class="swiper-slide">
                    <img src="assets/images/slider/home02/image02.jpg" class="banner-bg11" alt="image">
                    <div class="container">
        ...
        <div class="banner-form-wrapper">  
            <div class="container banner-form-container">
    ...
    <div class="intro-sectoin position-relative">
        <div class="video-wrapper sibling-2 ">
            ...
            <span class="watch-video">Play Video</span>
        </div>
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="intro-content">
                        ...
                        <p>This is Photoshop's version of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, loreendum auctor nisi elit consequat ipsum, nec sagittis sem nibh id elit. vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non mauris vitae erat consequat auctor eu in elit.</p>
                        <a href="about.php" class="eg-btn btn-primary2-outline sibling-2 btn--lg">Learn More</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 ">
                            ...
                            <div class="swiper-slide">
                                <div class="offer-single">
                                    ...
                                    <div class="content">
                                        ...
                                        <a href="tour-package-details.php">A tour of Amazon Forest. </a>
                                        <span>03 days / from $2500</span>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="offer-single">
                                    ...
                                    <div class="content">
                                        ...
                                        <a href="tour-package-details.php">Antelope Arizona America</a>
                                        <span>03 days / from $2500</span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="swiper-pagination-33 sibling-2 d-flex align-items-center justify-content-center mt-60"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="tour-package-section pt-120">
            ...
            <div class="row justify-content-start align-items-start">
                ...
                <div class="col-lg-6 col-md-4">
                    <div class="slider-arrows arrows-style-4 text-center d-md-flex d-none flex-row gap-5 justify-content-end align-items-center pt-1">
                        <div class="package1-prev swiper-prev-arrow" tabindex="0" role="button" aria-label="Previous slide"> 
                            <i class="bi bi-arrow-left"></i>
                         </div>
                        <div class="package1-next swiper-next-arrow" tabindex="0" role="button" aria-label="Next slide"> 
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="tour-package-single">
                                    <img src="assets/images/bg/package11.png" class="img-fluid" alt="image">
                                    <div class="package-content">
                                        <a href="tour-package-details.php"><h4>Aegean Adventure Beach!</h4> </a>
                                        <p>Lorem ipsum dolor sit amet, consectetur adi- piscing elit.</p>
                                        <span class="price">From $250</span>
                                    </div>
                                    <a href="tour-package-details.php" class="explore-btn">Explore Now</a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="tour-package-single">
                                    <img src="assets/images/bg/package12.png" class="img-fluid" alt="image">
                                    <div class="package-content">
                                        <a href="tour-package-details.php"><h4>Family Tour With America!</h4></a>
                                        <p>Lorem ipsum dolor sit amet, consectetur adi- piscing elit.</p>
                                        <span class="price">From $250</span>
                                    </div>
                                    <a href="tour-package-details.php" class="explore-btn">Explore Now</a>
                            ...
                            <div class="swiper-slide">
                                <div class="tour-package-single">
                                    <img src="assets/images/bg/package13.png" class="img-fluid" alt="image">
                                    <div class="package-content">
                                        <a href="tour-package-details.php"><h4>South America City Tour!</h4></a>
                                        <p>Lorem ipsum dolor sit amet, consectetur adi- piscing elit.</p>
                                        <span class="price">From $250</span>
                                    </div>
                                    <a href="tour-package-details.php" class="explore-btn">Explore Now</a>
                            ...
                            <div class="swiper-slide">
                                <div class="tour-package-single">
                                    <img src="assets/images/bg/package14.png" class="img-fluid" alt="image">
                                    <div class="package-content">
                                        <a href="tour-package-details.php"><h4>Tours in Ethuopia City!</h4></a>
                                        <p>Lorem ipsum dolor sit amet, consectetur adi- piscing elit.</p>
                                        <span class="price">From $250</span>
                                    </div>
                                    <a href="tour-package-details.php" class="explore-btn">Explore Now</a>
            ...
            <div class="counter-wrapper">
                <div class="row d-flex justify-content-center">
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-10">
                        <div class="counter-single sibling-2 text-center d-flex flex-column hover-border1">
                            ...
                            <div class="coundown d-flex flex-column">
                                <div class="d-flex flex-row justify-content-center align-items-center gap-2">
                                    <h3 class="odometer" data-odometer-final="400">100</h3><i class="bi bi-plus-lg"></i>
                                </div>
                                <p>Awesome Tour</p>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-10">
                      <div class="counter-single sibling-2 text-center d-flex flex-column hover-border1">
                        <div class="counter-icon">
                          ...
                          <div class="coundown d-flex flex-column">
                            <div class="d-flex flex-row justify-content-center align-items-center gap-2">
                                <h3 class="odometer" data-odometer-final="250">100</h3><i class="bi bi-plus-lg"></i>
                            </div>
                              <p>Stunning Places</p>
                          </div>
                      </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-10">
                      <div class="counter-single sibling-2 text-center d-flex flex-column hover-border1">
                        <div class="counter-icon">
                          ...
                          <div class="coundown d-flex flex-column">
                              <div class="d-flex flex-row justify-content-center align-items-center gap-2">
                                <h3 class="odometer" data-odometer-final="350">100</h3><i class="bi bi-plus-lg"></i>
                            </div>
    ...
    <div class="tour-place-section pt-120 pb-120">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6 text-center">
                    <div class="section-title2 text-center d-flex flex-column justify-content-center">
            ...
            <div class="tour-card-wrapper">
                <div class="col-40">
                    <div class="tour-card-alpha">
                        <div class="image">
                            <img src="assets/images/bg/tour1.png" class="img-fluid" alt="image">
                        </div>
                        <div class="tour-badge ms-md-5 mx-auto">
                            <h5><a href="destination-details.php">Halland Canals</a></h5>
                            <p>04 Tours Place</p>
                            <span></span>
                        </div>
                    </div>
                ...
                <div class="col-60">
                    <div class="tour-card-beta">
                        <div class="image"> 
                            <img src="assets/images/bg/tour2.png" class="img-fluid" alt="image">
                        </div>
                        <div class="tour-badge sibling-2 mx-auto">
                            <h5><a href="destination-details.php">Grand Switzerland.</a></h5>
                            <p>04 Tours Place</p>
                            <span></span>
                        </div>
                    </div>
                ...
                <div class="col-30">
                    <div class="tour-card-gamma">
                        <div class="image">
                            <img src="assets/images/bg/tour3.png" class="img-fluid" alt="image">
                        </div>
                        <div class="tour-badge mx-auto">
                            <h5><a href="destination-details.php">Toronto</a></h5>
                            <p>02 Tours Place</p>
                            <span></span>
                        </div>
                    </div>
                ...
                <div class="col-40">
                    <div class="tour-card-delta">
                        <div class="image">
                            <img src="assets/images/bg/tour4.png" class="img-fluid" alt="image">
                        </div>
                        <div class="tour-badge mx-auto">
                            <h5><a href="destination-details.php">Marbella</a></h5>
                            <p>05 Tours Place</p>
                            <span></span>
                        </div>
                    </div>
                ...
                <div class="col-30">
                    <div class="tour-card-gamma">
                        <div class="image">
                            <img src="assets/images/bg/tour5.png" class="img-fluid" alt="image">
                        </div>
                        <div class="tour-badge mx-auto">
                            <h5><a href="destination-details.php">Romantic Paris</a></h5>
                            <p>04 Tours Place</p>
                            <span></span>
                        </div>
                    </div>
    ...
    <div class="feature-section mb-120">
        <div class="container-xl container-lg-fluid container">
            <div class="row align-items-center">
                <div class="col-lg-6 d-lg-block d-none">
                    <div class="feature-image">
                        <img src="assets/images/bg/feature-img.png" class="img-fluid" alt="image">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="feature-content">
                        ...
                        <p class="para">Dolor sit amet, consectetur adi- piscing elit. sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        ...
                        <a href="destination.php" class="eg-btn btn--primary2 btn--lg">Explorer Now</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="blog-section pt-120 pb-120 overflow-hidden">
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-lg-4 col-md-6 col-sm-10">
                    <div class="blog-single2">
                        <div class="image">
                            <img src="assets/images/blog/blog21.png" class="img-fluid" alt="image">
                            <span class="blog-category">Travel / Style</span>
                        </div>
                        <div class="content">
                            <h5><a href="blog-details.php">The social art of zaha Hadid, architecture’s presence</a></h5>
                            <div class="blog-date">
                                <i class="bi bi-calendar-check"></i><span>February 8, 2022</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-10">
                    <div class="blog-single2">
                        <div class="image">
                            <img src="assets/images/blog/blog22.png" class="img-fluid" alt="image">
                            <span class="blog-category">City Travel</span>
                        </div>
                        <div class="content">
                            <h5><a href="blog-details.php">Li river, China’s orignial postcard landcaspe</a></h5>
                            <div class="blog-date">
                                <i class="bi bi-calendar-check"></i><span>February 10, 2022</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-10">
                    <div class="blog-single2">
                        <div class="image">
                            <img src="assets/images/blog/blog23.png" class="img-fluid" alt="image">
                            <span class="blog-category">Travel / Style</span>
                        </div>
                        <div class="content">
                            <h5><a href="blog-details.php">Jungles in Paris vermont’s rugged, retro Ski mountain</a></h5>
                            <div class="blog-date">
                                <i class="bi bi-calendar-check"></i><span>March 12, 2022</span>
                            </div>
                        </div>
                    </div>
                </div>
     ...
     <div class="testimonial-section pb-120 overflow-hidden position-relative">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6 text-center">
                    <div class="section-title2 text-center d-flex flex-column justify-content-center">
