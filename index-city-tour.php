    ...
    <div class="page-wrapper">
        <div class="main-nav-wrapper">
            <div class="main-nav">
                ...
                <div class="mobile-logo-area d-flex justify-content-xl-center justify-content-start align-items-center">
                    <div class="header-logo">
                        <a href="index.php"><img alt="image" class="img-fluid" src="assets/images/icons/header4-logo.svg"></a>
                    </div>
                </div>
                <ul class="menu-list">
                    <li class="menu-item-has-children">
                        <a href="#" class="drop-down"><img src="assets/images/icons/home-icon.svg" alt="image"> Home</a><i class='bi bi-chevron-down dropdown-icon'></i>
                        <ul class="sub-menu">
                            <li><a href="index.php">Travel Agency 01</a></li>
                            <li><a href="index-travel2.php">Travel Agency 02</a></li>
                            <li><a href="city-tour-index.php">City Tour</a></li>
                            <li><a href="index-adventure.php">Adventure</a></li>
                            <li><a href="index-wildlife.php">Wild life</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children">
                        <a href="destination.php" class="drop-down"><img src="assets/images/icons/desitnation-icon.svg" alt="image"> Destination</a><i class='bi bi-chevron-down dropdown-icon'></i>
                        <ul class="sub-menu">
                    ...
                    <li class="menu-item-has-children">
                        <a href="blog-grid.php"><img src="assets/images/icons/tour-icon.svg" alt="image"> Tours</a><i class='bi bi-chevron-down dropdown-icon'></i>
                        <ul class="sub-menu">
                    ...
                    <li class="menu-item-has-children">
                        <a href="#" class="drop-down"><img src="assets/images/icons/pages.svg" alt="image"> Pages</a><i class='bi bi-chevron-down dropdown-icon'></i>
                        <ul class="sub-menu">
                    ...
                    <li class="menu-item-has-children">
                        <a href="blog-grid.php"><img src="assets/images/icons/blog-icon.svg" alt="image"> Blog</a><i class='bi bi-chevron-down dropdown-icon'></i>
                        <ul class="sub-menu">
                    ...
                    <li><a href="contact.php"><img src="assets/images/icons/contact-icon.svg" alt="image"> Contact Us</a></li>
                </ul>
                <a href="login.php" class="uesr-aera"><i class="bi bi-person-circle"></i></a>
            </div>
        </div>
        <!-- ========== header end============= -->
        ...
        <div class="main-content-area">
            <header class="style-3">
                <div class="nav-right d-flex jsutify-content-end align-items-center gap-5">
                    <div class="phone-call sibling4 justify-content-start align-items-center flex-row d-xl-flex d-none">
                        <div class="icon">
                        ...
                        <div class="number">
                            <h5><a href="tel:+8801701111000">+8801701111000</a></h5>
                        </div>
                    </div>
                    <div class="phone-call sibling4 justify-content-start align-items-center flex-row d-xxl-flex d-none">
                        <div class="icon">
                ...
                <div class="header-logo d-xl-none d-flex">
                    <a href="index.php"><img alt="image" class="img-fluid" src="assets/images/icons/header4-logo.svg"></a>
                </div>
                <div class="header-social-area sibling-2 d-xl-flex d-none">
            ...
            <div class="banner-section3 overflow-hidden position-relative ml-230"> 
                <img src="assets/images/slider/home03/image02.jpg" class="banner-bg31" alt="image">
                <div class="container">
                    <div class="row justify-content-center align-items-center g-4">
                        <div class="col-xl-8 col-lg-8 col-md-12 text-lg-start text-center">
                            <div class="banner3-content">
                                ...
                                <a href="destination.php" class="eg-btn btn--white btn--lg">Discover More</a>
                            </div> 
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-10">
                            <div class="banner-form-box sibling-2">
                                ...
                                <form class="banner-form">
                                    ...
                                    <button class="eg-btn btn--primary2 btn--lg w-100">Find Now</button>
                                </form>
                            </div>
                        </div>
                    </div>
            ...
            <div class="offer-section sibling-2 pt-120 pb-120">
                <div class="container">
                    <div class="row">
                        <div class="col-12 ">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="offer-single sibling-2">
                                            <img src="assets/images/bg/offer-bg1.png" class="offer-bg" alt="image">
                                            <img src="assets/images/bg/offer-badge1.svg" class="offer-badge" alt="image">
                                            <div class="content">
                                                ...
                                                <a href="tour-package-details.php">Epcot Center Drive, Orlando</a>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="offer-single sibling-2">
                                            <img src="assets/images/bg/offer-bg2.png" class="offer-bg" alt="image">
                                            <img src="assets/images/bg/offer-badge2.svg" class="offer-badge" alt="image">
                                            <div class="content">
                                                <div class="review-area sibling-2">
                                                    <ul class="star-list">
                                                        <li><i class="bi bi-star-fill"></i></li>
                                                ...
                                                <a href="tour-package-details.php">Aegean Adventure Cruise</a>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="offer-single sibling-2">
                                            <img src="assets/images/bg/offer-bg3.png" class="offer-bg" alt="image">
                                            <img src="assets/images/bg/offer-badge3.svg" class="offer-badge" alt="image">
                                            <div class="content">
                                                <div class="review-area sibling-2">
                                                    <ul class="star-list">
                                                        <li><i class="bi bi-star-fill"></i></li>
                                                ...
                                                <a href="tour-package-details.php">South America Tours</a>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="offer-single sibling-2">
                                            <img src="assets/images/bg/offer-bg4.png" class="offer-bg" alt="image">
                                            <img src="assets/images/bg/offer-badge3.svg" class="offer-badge" alt="image">
                                            <div class="content">
                                                <div class="review-area sibling-2">
                                                    <ul class="star-list">
                                                ...
                                                <a href="tour-package-details.php">Egypt tour</a>
                                                <span>2 days / from $400</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="feature-section2 pb-120">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-6 ps-lg-5">
                            <div class="about3-title text-start">
                                <span>Welcome Kendi Travel</span>
                            ...
                            <a href="tour-package.php" class="eg-btn btn--primary3-outline sibling-2 btn--lg">Find tours</a>
                        </div>
                        <div class="col-lg-6">
                            <div class="feature-image-group d-flex flex-row justify-content-center gap-5">
                                ...
                                <div class="feature-image">
                                    <img src="assets/images/bg/feature3.png" class="img-fluid" alt="image">
                                </div>
                                <div class="feature-image translate-y">
                                    <img src="assets/images/bg/feature4.png" class="img-fluid" alt="image">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="gallery-wrapper">
                            <div class="box c">
                                <div class="destination-single2">
                                    ...
                                    <div class="destination-content">
                                        <h4><a href="destination-details.php">Croatia</a></h4>
                            ...
                            <div class="box d">
                                <div class="destination-single2">
                                    ...
                                    <div class="destination-content">
                                        <h4><a href="destination-details.php">China</a></h4>
                                        <p><span>10</span> Tour’s Place</p>
                                    </div>
                                </div>
                            </div>
                            <div class="box e">
                                <div class="destination-single2">
                                    ...
                                    <div class="destination-content">
                                        <h4><a href="destination-details.php">Egypt</a></h4>
                                        <p><span>10</span> Tour’s Place</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box g">
                                <div class="destination-single2">
                                    ...
                                    <div class="destination-content">
                                        <h4><a href="destination-details.php">KualaLumpur</a></h4>
                                        <p><span>10</span> Tour’s Place</p>
                                    </div>
                                </div>
                            </div>
                            <div class="box f">
                                <div class="destination-single2">
                                    ...
                                    <div class="destination-content">
                                        <h4><a href="destination-details.php">Bangkok</a></h4>
                                        <p><span>10</span> Tour’s Place</p>
                                    </div>
                                </div>
                            </div>
                            <div class="box h">
                                <div class="destination-single2">
                                    ...
                                    <div class="destination-content">
                                        <h4><a href="destination-details.php">France</a></h4>
                                        <p><span>10</span> Tour’s Place</p>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="tour-package-section2 pt-120      pb-120">
                <div class="container">
                    <div class="row justify-content-start align-items-center mb-60">
                        <div class="col-lg-6 col-md-12 text-md-start text-center">
                            <div class="section-title3 d-flex flex-column justify-content-center mb-0">
                                ...
                                <h2>Get The Best Kendi Travel Tour’s</h2>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-4">
                            <div class="slider-arrows arrows-style-4 text-center d-md-flex d-none flex-row gap-5 justify-content-end align-items-center pt-1">
                                <div class="package2-prev swiper-prev-arrow" tabindex="0" role="button" aria-label="Previous slide"> 
                                    <i class="bi bi-arrow-left"></i>
                                 </div>
                                <div class="package2-next swiper-next-arrow" tabindex="0" role="button" aria-label="Next slide"> 
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="tour-package-single2">
                                            <div class="image">
                                                <img src="assets/images/bg/package21.png" class="img-fluid" alt="image">
                                                <span class="blog-date"><i class="bi bi-calendar-check"></i>From $2250</span>
                                            </div>
                                            <div class="content">
                                                <h4><a href="tour-package-details.php">Great Wall, China</a></h4>
                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                                <a href="tour-package-details.php" class="read-more-btn sibling-2">Explorer Now<i class="bi bi-arrow-right"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="tour-package-single2">
                                            <div class="image">
                                                <img src="assets/images/bg/package22.png" class="img-fluid" alt="image">
                                                <span class="blog-date"><i class="bi bi-calendar-check"></i>From $2250</span>
                                            </div>
                                            <div class="content">
                                                <h4><a href="tour-package-details.php">Colosseum, Rome</a></h4>
                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                                <a href="tour-package-details.php" class="read-more-btn sibling-2">Explorer Now<i class="bi bi-arrow-right"></i></a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tour-package-single2">
                                            <div class="image">
                                                <img src="assets/images/bg/package23.png" class="img-fluid" alt="image">
                                                <span class="blog-date"><i class="bi bi-calendar-check"></i>From $2250</span>
                                            </div>
                                            <div class="content">
                                                <h4><a href="tour-package-details.php">Tour in Egypt</a></h4>
                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                                <a href="tour-package-details.php" class="read-more-btn sibling-2">Explorer Now<i class="bi bi-arrow-right"></i></a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tour-package-single2">
                                            <div class="image">
                                                <img src="assets/images/bg/package24.png" class="img-fluid" alt="image">
                                                <span class="blog-date"><i class="bi bi-calendar-check"></i>From $2250</span>
                                            </div>
                                            <div class="content">
                                                <h4><a href="tour-package-details.php">Taj Mahal, India</a></h4>
                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                                <a href="tour-package-details.php" class="read-more-btn sibling-2">Explorer Now<i class="bi bi-arrow-right"></i></a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tour-package-single2">
                                            ...
                                            <div class="content">
                                                <h4><a href="tour-package-details.php">The Colosseum, Rome</a></h4>
                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                                <a href="tour-package-details.php" class="read-more-btn sibling-2">Explorer Now<i class="bi bi-arrow-right"></i></a>
                                            </div>
                                        </div>
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-6 text-center">
                            <div class="section-title3">
                                <span>Find Destinations</span>
                                <h2>Kendi Travel Extra Facilities.</h2>
                            </div>
                        </div>
                    </div>
            ...
            <div class="video-section2 position-relative">
                <div class="video-wrapper sibling-4">
                    <div class="video-play sibling-2">
                ...
                <div class="container">
                    <div class="row justify-content-center align-items-center g-4">
                        <div class="col-lg-12 col-md-10">
                            <div class="video-section-content sibling-2">
                                <h2>Explore Your Travel</h2>
                                <p class="para">Your New Traveling Idea</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="tour-guide-section pt-120 pb-120">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-6 text-center">
                            <div class="section-title3">
                    ...
                    <div class="row g-4 justify-content-center">
                        ...
                        <div class="tour-guide-single">
                                <div class="guide-image">
                                    <img src="assets/images/bg/guide1.png" class="img-fluid" alt="image">
                                ...
                                <div class="guide-contnent">
                                    <h4><a href="tour-guide.php">Savannah Nguyen</a></h4>
                                    <p>Tour Guide  </p>
                                </div>
                        </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-10">
                            <div class="tour-guide-single">
                                <div class="guide-image">
                                    <img src="assets/images/bg/guide2.png" class="img-fluid" alt="image">
                                    <div class="social-area">
                                        <ul class="guide-social">
                                            <li><a href="https://www.facebook.com/"><i class='bx bxl-facebook'></i></a></li>
                                            <li><a href="https://www.twitter.com/"><i class='bx bxl-twitter'></i></a></li>
                                ...
                                <div class="guide-contnent">
                                    <h4><a href="tour-guide.php">Kristin Watson</a></h4>
                                    <p>Tour Guide  </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-10">
                            <div class="tour-guide-single">
                                <div class="guide-image">
                                    <img src="assets/images/bg/guide3.png" class="img-fluid" alt="image">
                                    <div class="social-area">
                                        <ul class="guide-social">
                                            <li><a href="https://www.facebook.com/"><i class='bx bxl-facebook'></i></a></li>
                                            <li><a href="https://www.twitter.com/"><i class='bx bxl-twitter'></i></a></li>
                                ...
                                <div class="guide-contnent">
                                    <h4><a href="tour-guide.php">Watson Krick</a></h4>
                                    <p>Tour Guide  </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row g-4 justify-content-center">
                        <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-10">
                            <div class="blog-single3">
                                <div class="image">
                                    <img src="assets/images/blog/blog31.png" class="img-fluid" alt="image">
                                    <span class="blog-date"><i class="bi bi-calendar-check"></i>25 Sep 2022</span>
                                </div>
                                <div class="content">
                                    <span class="category">Holiday, Place</span>
                                    <h4><a href="blog-details.php">The Social art of Zaha Hadid Arch Engaging.</a></h4>
                                    <a href="blog-details.php" class="read-more-btn sibling-2">Continue Reading<i class="bi bi-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-10">
                            <div class="blog-single3">
                                <div class="image">
                                    <img src="assets/images/blog/blog32.png" class="img-fluid" alt="image">
                                    <span class="blog-date"><i class="bi bi-calendar-check"></i>25 Sep 2022</span>
                                </div>
                                <div class="content">
                                    <span class="category">Holiday, Place</span>
                                    <h4><a href="blog-details.php">A True Horseman’s Tale For a Year.</a></h4>
                                    <a href="blog-details.php" class="read-more-btn sibling-2">Continue Reading<i class="bi bi-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-10">
                            <div class="blog-single3">
                                <div class="image">
                                    <img src="assets/images/blog/blog33.png" class="img-fluid" alt="image">
                                    <span class="blog-date"><i class="bi bi-calendar-check"></i>25 Sep 2022</span>
                                </div>
                                <div class="content">
                                    <span class="category">Holiday, Place</span>
                                    <h4><a href="blog-details.php">Safety Measures for trekking waterafal </a></h4>
                                    <a href="blog-details.php" class="read-more-btn sibling-2">Continue Reading<i class="bi bi-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-10">
                            <div class="blog-single3">
                                <div class="image">
                                    <img src="assets/images/blog/blog34.png" class="img-fluid" alt="image">
                                    <span class="blog-date"><i class="bi bi-calendar-check"></i>25 Sep 2022</span>
                                </div>
                                <div class="content">
                                    <span class="category">Holiday, Place</span>
                                    <h4><a href="blog-details.php">Day out on the he de re, getting hotter.</a></h4>
                                    <a href="blog-details.php" class="read-more-btn sibling-2">Continue Reading<i class="bi bi-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="newsletter-section">
                <div class="container">
                    <div class="newsletter-area row justify-content-center align-items-center">
